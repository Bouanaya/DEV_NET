    ...
    <main class="flex">
        ...
        <aside class="bg-gray-900 w-64 min-h-screen p-4">
            <ul class="space-y-2 mt-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-800 rounded"><a href="#" class="text-white">Articles</a></li>
                <li class="px-4 py-2 hover:bg-gray-800 rounded"><a href="../Layout/tagAdmin.php" class="text-sky-400">Tag</a></li>
